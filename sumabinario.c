/*	Sistemas programables
	...
	7-8 am
	Suma de numeros binarios con acarreo
*/
...
int main(void){ 
	...
	int i, j;
 	...
 	if (readline(num)){ 
		...
		puts("Numeros invalidos, deben de tener entre 6-8 caracteres"); 
		return EXIT_FAILURE; 
	}
} 
...
void binarysum(char num[][NUM_BITS], char result[]){ 
	...
	for (i = NUM_BITS; i > 0; i--){ 
		bit_1 = num[0][i-1]; bit_2 = num[1][i-1]; 
